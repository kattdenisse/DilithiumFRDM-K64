...
void poly_power2round(poly *a1, poly *a0, const poly *a) {
  ...
  for(i = 0; i < N; i=i+8)
  {
    ...
    a1->coeffs[i+2] = power2round(&a0->coeffs[i+2], a->coeffs[i+2]);
    a1->coeffs[i+3] = power2round(&a0->coeffs[i+3], a->coeffs[i+3]);
    a1->coeffs[i+4] = power2round(&a0->coeffs[i+4], a->coeffs[i+4]);
    a1->coeffs[i+5] = power2round(&a0->coeffs[i+5], a->coeffs[i+5]);
    a1->coeffs[i+6] = power2round(&a0->coeffs[i+6], a->coeffs[i+6]);
    a1->coeffs[i+7] = power2round(&a0->coeffs[i+7], a->coeffs[i+7]);
  }
...
void poly_decompose(poly *a1, poly *a0, const poly *a) {
  ...
  for(i = 0; i < N; i=i+8)
  {
    ...
    a1->coeffs[i+2] = decompose(&a0->coeffs[i+2], a->coeffs[i+2]);
    a1->coeffs[i+3] = decompose(&a0->coeffs[i+3], a->coeffs[i+3]);
    a1->coeffs[i+4] = decompose(&a0->coeffs[i+4], a->coeffs[i+4]);
    a1->coeffs[i+5] = decompose(&a0->coeffs[i+5], a->coeffs[i+5]);
    a1->coeffs[i+6] = decompose(&a0->coeffs[i+6], a->coeffs[i+6]);
    a1->coeffs[i+7] = decompose(&a0->coeffs[i+7], a->coeffs[i+7]);
  }
...
void poly_use_hint(poly *b, const poly *a, const poly *h) {
  ...
  for(i = 0; i < N; i=i+8)
  {
    ...
    b->coeffs[i+2] = use_hint(a->coeffs[i+2], h->coeffs[i+2]);
    b->coeffs[i+3] = use_hint(a->coeffs[i+3], h->coeffs[i+3]);
    b->coeffs[i+4] = use_hint(a->coeffs[i+4], h->coeffs[i+4]);
    b->coeffs[i+5] = use_hint(a->coeffs[i+5], h->coeffs[i+5]);
    b->coeffs[i+6] = use_hint(a->coeffs[i+6], h->coeffs[i+6]);
    b->coeffs[i+7] = use_hint(a->coeffs[i+8], h->coeffs[i+7]);
  }
